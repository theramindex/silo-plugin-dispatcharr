...
- Build: Dispatcharr `v0.3.89`, using Sportarr event artwork with team/league marks, full team names centered beneath their logos, stable team shelf cards, a denser responsive event grid, status pills, a consistent featured-event fallback, and animated inline channel disclosure on event cards.

## Automated verification

- `node --check internal/plugin/ui/app.js`: passed
- `go test ./...`: passed
- release verification for `0.3.89`: passed
